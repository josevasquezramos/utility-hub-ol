                ...
                <div class="hidden space-x-8 sm:-my-px sm:flex">
                    ...
                    <div class="relative h-full flex items-center" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                             ...
                             class="absolute z-50 mt-2 w-48 rounded-md shadow-lg origin-top-left left-0 top-full bg-white ring-1 ring-black ring-opacity-5 py-1"
                             style="display: none;"> <a href="{{ route('schedule.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition ease-in-out duration-150">
                                {{ __('Cronograma') }}
                            </a>
                        </div>
                    </div>
